...
new_activity = Activity('New Activity', [
    ListQuestion('What are your wins for the day?'),
    ListQuestion('What is working?'),
    ListQuestion('What is not working?'),
    Question('What would you like to dream about tonight?'),
])
